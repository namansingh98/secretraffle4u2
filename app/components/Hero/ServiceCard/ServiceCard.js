  ...
  return (
    <>
      <div className="Service w-[90%] md:w-full xl:w-full">
        <div className="service_title items-center flex flex-col font-semibold justify-center text-white md:text-2xl xl:text-4xl text-md mb-5 mt-10">
          <div className="flex justify-center justify-items-center items-center">
            ...
            <div className="sm:block sm:text-center xs:block xs:text-center  lg:flex md:flex  items-center text-md md:text-md xl:text-xl">
              &nbsp;
              <div className="flex justify-center "> Total Jackpot for</div>
        ...
        <div className="container mx-auto mt-8 flex flex-col md:flex-row xl:flex-row justify-center">
          <div className="border border-gray-300 p-6 rounded-lg shadow-lg mx-4 my-4 flex flex-col items-center w-full md:w-1/2 lg:w-1/3 xl:w-1/3">
            <div className="flex items-center justify-between w-full mb-4">
              <span className="bg-[#487644] p-5 rounded-full border  border-[#F5D148]">
                <Image
                  src={compliant}
              ...
              <div className="w-2/3 pl-4">
                ...
                <ul className="list-none list-inside text-sm text-white leading-6		 ">
                  ...
                  <li>
                    ✓ Top of The Range Anti-Fraud and Anti-Money Laundering
                    Detection
                  </li>
                </ul>
              </div>
            ...
            <div className="flex items-center justify-between w-full mb-4">
              ...
              <div className="w-2/3 pl-4">
                ...
                <ul className="list-none list-inside text-sm text-white leading-7		">
                  ...
                  <li>
                    ✓ All Data Are Secured Under Layers of Security Software’s.
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between w-full mb-4">
              ...
              <div className="w-2/3 pl-4">
                ...
                <ul className="list-none list-inside text-sm text-white leading-7	">
                  ...
                  <li>
                    ✓ We Have Partnered Up With “Expat Gift cards”. So, You can
                    purchase gift cards, which will automatically be deposited
